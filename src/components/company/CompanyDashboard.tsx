...
export default function CompanyDashboard() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'emi-collection':
        return <EMICollectionSection user={user} />;
      
      case 'emi-calendar':
        return <EMICalendar user={user} />;
          ...
          <div className="space-y-6">
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent>
                  <OfflineLoanForm user={user} onSuccess={fetchData} />
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
      ...
      case 'personalCredits':
        return <MyCreditPassbook user={user} />;
