...
const STEPS = [
  ...
  { id: 6, title: 'References', icon: Users, description: 'Contact references' },
  ...
  const validateCurrentStep = (): boolean => {
    ...
    switch (currentStep) {
      ...
      case 5:
        ...
        break;
      case 6:
        // References are optional but if provided, need phone validation
      ...
      case 6:
        return (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500">Add at least two references for verification purposes.</p>
            <div className="space-y-6">
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                <h5 className="font-medium mb-3 text-gray-700">Reference 1</h5>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
              ...
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                <h5 className="font-medium mb-3 text-gray-700">Reference 2</h5>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
            ...
            <div className="p-4 bg-gray-50 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                {[
                  ...
                  { label: 'References Added', checked: !!(loanForm.ref1Name || loanForm.ref2Name) },
                ].map((item) => (
