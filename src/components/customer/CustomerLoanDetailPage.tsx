...
export default function CustomerLoanDetailPage() {
  ...
  const handlePartialPayment = async () => {
    if (!selectedEmi || !user || !partialAmount || !nextPaymentDate) return;
    
    const amount = parseFloat(partialAmount);
    if (amount <= 0 || amount >= selectedEmi.totalAmount) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({ 
          ...
          description: `Payment of ${formatCurrency(amount)} processed. Next payment due on ${formatDate(nextPaymentDate)}` 
        });
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <p className="font-semibold">{loan.sessionForm?.interestRate}% p.a.</p>
              </div>
              <div>
            ...
            <ScrollArea className="h-[400px]">
              <div className="divide-y">
                {emiSchedules.map((emi, index) => {
                  ...
                  const isPending = emi.paymentStatus === 'PENDING';
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              ...
                              {emi.originalDueDate && emi.originalDueDate !== emi.dueDate && (
                                <span className="text-xs text-gray-400 ml-2">
                                  (Original: {formatDate(emi.originalDueDate)})
                                </span>
                              )}
                            </p>
                            {emi.isInterestOnly && (
      ...
      <Dialog open={showPartialDialog} onOpenChange={setShowPartialDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Pay a portion of your EMI now and schedule the remaining payment for a later date
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                Must be less than total EMI amount
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">
                Next EMI will be scheduled on this date
              </p>
            </div>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
              ...
              <ul className="text-xs text-amber-700 mt-2 space-y-1 list-disc list-inside">
                ...
                <li>Next EMI due date will be one month from today</li>
              </ul>
            </div>
