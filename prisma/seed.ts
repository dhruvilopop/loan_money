...
async function main() {
  ...
  await db.systemSetting.upsert({
    ...
    update: { value: 'Money Mitra Finance' },
    create: { key: 'companyName', value: 'Money Mitra Finance' }
  });
  ...
  const testimonials = [
    {
      ...
      content: 'Money Mitra helped me expand my business with their quick loan approval. The process was smooth and the team was very supportive.',
      rating: 5,
      isActive: true,
      order: 1
    },
    {
      ...
      content: 'Got my dream home with Money Mitra\'s home loan. The interest rates were very competitive and the staff was helpful throughout.',
      rating: 5,
      isActive: true,
      order: 2
    },
